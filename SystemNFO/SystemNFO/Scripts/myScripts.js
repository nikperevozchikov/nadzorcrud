...
function LoadOrganization(element) {
...
function renderOrganization(element) {
    var $ele = $(element);
    $ele.empty();
    $ele.append($('<option/>').val('0').text('Select'));
    $.each(Organization, function (i, val) {
        $ele.append($('<option/>').val(val.OrganizationId).text(val.Vidorg));
    })
}
