namespace SystemNFO.Migrations
{
    ...
    public partial class Low5 : DbMigration
    {
        public override void Up()
        {
            AlterColumn("dbo.Events", "Databegin", c => c.DateTime(precision: 7, storeType: "datetime2"));
            AlterColumn("dbo.Events", "Dataend", c => c.DateTime(precision: 7, storeType: "datetime2"));
        }
